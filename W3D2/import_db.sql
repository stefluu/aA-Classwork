...
-- VALUES 
--   ('How to do this', 'You cannot do this', (SELECT id FROM users WHERE fname = 'Nick'));
-- 
-- 
-- -- INSERT INTO
-- --   questionfollows (user_id, question_id)
-- -- VALUES
-- --   (SELECT id FROM users WHERE fname = 'Stefanie' AND lname = 'Luu')
-- 
-- INSERT INTO 
--   replies (parent_id, user_id, question_id)
-- VALUES 
--   (0, 2, 1);
